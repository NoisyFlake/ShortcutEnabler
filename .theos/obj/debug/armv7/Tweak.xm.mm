...
static void _logos_method$_ungrouped$SBDashBoardQuickActionsViewController$touchEndedForButton$(_LOGOS_SELF_TYPE_NORMAL SBDashBoardQuickActionsViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id arg1) {
	if (!require3DTouch) {
		return;
	} else {
		_logos_orig$_ungrouped$SBDashBoardQuickActionsViewController$touchEndedForButton$(self, _cmd, arg1);
	}
}
